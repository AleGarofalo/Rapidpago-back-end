...
exports.up = function(knex) {
    return knex.schema.createTable('terminal_categories', function(table) {
...
exports.down = function(knex) {
    return knex.schema.dropTable('terminal_categories'); // Reversión de la migración eliminando la tabla IndustryType
};