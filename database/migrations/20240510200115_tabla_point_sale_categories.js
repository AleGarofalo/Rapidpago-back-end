...
exports.up = function(knex) {
    return knex.schema.createTable('point_sale_categories', function(table) {
...
exports.down = function(knex) {
    return knex.schema.dropTable('point_sale_categories'); // Reversión de la migración eliminando la tabla IndustryType
};